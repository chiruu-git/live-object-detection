...
function predictWebcam() {
  ...
  model.detect(video).then(function(predictions) {
      ...
      // Now lets loop through predictions and draw them to the live view
      // if they have a high confidence score.
      for (let n = 0; n < predictions.length; n++) {
          ...
          if (predictions[n].score > 0.66) {
              ...
              p.style = 'margin-left: ' + predictions[n].bbox[0] + 'px; margin-top: ' + (predictions[n].bbox[1] - 10) + 'px; width: ' + (predictions[n].bbox[2] - 10) + 'px; top: 0; left: 50;';
